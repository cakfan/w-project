  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-2xl font-bold md:text-6xl">
          Roadmap
        </h2>
        <p className="text-leading max-w-sm">
          Ini cuma gambaran kasar aja. Nanti prakteknya bisa beda, tergantung
          situasi. Setiap tahap juga nggak ada batas waktu yang pasti, jadi
          fleksibel aja.
        </p>
      </div>
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0 w-[2px] rounded-full bg-gradient-to-t from-pink-500 from-[0%] via-purple-500 via-[10%] to-transparent"
          />
        </div>
      </div>
    </div>
